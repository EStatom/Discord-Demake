...
//Adding a variable to set a button to "clicked" and change the style.  Clicking one disables the others.
  ...
  return (
    <div style={styles.sidebar}>    
      ...
      <div onMouseEnter={() => setIsHovering5(true)} onMouseLeave={() => setIsHovering5(false)} style={isClicked5 || isHovering5 ? styles.iconContainerHover : styles.iconContainer}>
        <button style={isClicked5 ? styles.serverIconHover : styles.serverIcon} onClick={handleButtonClick5}> 
          <img src="https://unsplash.it/600/400?image=163" alt="Server Icon"  style={isClicked5 ? styles.serverIconHover : styles.serverIcon}/>
        </button>
      </div> 
    </div>
  );
